...
You are given a research hypothesis.
...
def create_critique_analyst_agent(
    ...
    **kwargs,
    ...
    """Creates a critique analyst agent that evaluates the research hypothesis."""
    ...
    def agent(state: HypgenState) -> HypgenState:
        """Evaluate the research hypothesis and provide critique."""
